...
def _normalize_log_level(ctx, param, value):
    """Normalize log level input to uppercase.

    Accepts case-insensitive input and returns the canonical
    uppercase representation expected by the rest of the app.
    """
