...
class ErrorResponse(OpenAIBaseModel):
    ...
    param: Optional[str] = Field(
        None, description="The parameter related to the error, if any."
    )
...
class ChatCompletionContentPartImage(OpenAIBaseModel):
    ...
    type: Literal["image_url"] = Field(
        ..., description="The type of content, e.g., 'image_url'."
    )
...
class ChatCompletionContentPartVideo(OpenAIBaseModel):
    ...
    type: Literal["video_url"] = Field(
        ..., description="The type of content, e.g., 'video_url'."
    )
...
class Message(OpenAIBaseModel):
    ...
    content: Optional[Union[str, List[ChatCompletionContentPart]]] = Field(
        None,
...
class ChatCompletionRequestBase(OpenAIBaseModel):
    ...
    model: str = Field(
        Config.TEXT_MODEL, description="The model to use for completion."
    )
    ...
    min_p: Optional[float] = Field(
        0.0, description="Minimum probability for token generation."
    )
...
class ChatCompletionResponse(OpenAIBaseModel):
    ...
    usage: Optional[UsageInfo] = Field(
        default=None, description="The usage of the completion."
    )
...
class ChoiceDeltaFunctionCall(OpenAIBaseModel):
    ...
    arguments: Optional[str] = Field(
        None, description="Arguments for the function call delta."
    )
...
class ChoiceDeltaToolCall(OpenAIBaseModel):
    ...
    function: Optional[ChoiceDeltaFunctionCall] = Field(
...
class Delta(OpenAIBaseModel):
    ...
    function_call: Optional[ChoiceDeltaFunctionCall] = Field(
    ...
    reasoning_content: Optional[str] = Field(
        None, description="Reasoning content, if any."
    )
...
class StreamingChoice(OpenAIBaseModel):
    ...
    delta: Optional[Delta] = Field(
        None, description="The delta for this streaming choice."
    )
...
class ChatCompletionChunk(OpenAIBaseModel):
    ...
    usage: Optional[UsageInfo] = Field(
        default=None, description="The usage of the chunk."
    )
...
class EmbeddingRequest(OpenAIBaseModel):
    ...
    model: str = Field(
        Config.EMBEDDING_MODEL, description="The embedding model to use."
    )
...
class EmbeddingResponse(OpenAIBaseModel):
    ...
    usage: Optional[UsageInfo] = Field(
        default=None, description="The usage of the embedding."
    )
...
class ImageGenerationRequest(OpenAIBaseModel):
    ...
    response_format: Optional[ImageResponseFormat] = Field(
...
class ImageEditRequest(OpenAIBaseModel):
    ...
    negative_prompt: Optional[str] = Field(
        None, description="The negative prompt for the image edit"
    )
    guidance_scale: Optional[float] = Field(
...
class TranscriptionRequest(OpenAIBaseModel):
    ...
    response_format: Optional[TranscriptionResponseFormat] = Field(
        default=TranscriptionResponseFormat.JSON,
        description="The format in which the transcription is returned",
    )
    stream: Optional[bool] = Field(
        default=False, description="Whether to stream the transcription"
    )
    temperature: Optional[float] = Field(
        default=0.0, description="The temperature for the transcription"
    )
    top_p: Optional[float] = Field(
        default=None, description="The top-p for the transcription"
    )
    top_k: Optional[int] = Field(
        default=None, description="The top-k for the transcription"
    )
    min_p: Optional[float] = Field(
        default=None, description="The min-p for the transcription"
    )
    seed: Optional[int] = Field(
        default=None, description="The seed for the transcription"
    )
    frequency_penalty: Optional[float] = Field(
...
class TranscriptionResponse(OpenAIBaseModel):
    ...
    usage: TranscriptionUsageAudio = Field(
